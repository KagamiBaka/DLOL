...
export _dataset_name="reuters"
export accumulate_steps=1
export is_fp16=1
export vanilla_seq2seq=0
# export eval_steps=36
# export warmup_steps=36
export constraint_decoding='--constraint_decoding'

OPTS=$(getopt -o b:d:m:i:t:s:l:f: --long batch:,device:,model:,data:,task:,seed:,lr:,lr_scheduler:,label_smoothing:,epoch:,format:,eval_steps:,warmup_steps:,train_data:,_dataset_name:,accumulate_steps:,wo_constraint_decoding,is_fp16:,vanilla_seq2seq: -n 'parse-options' -- "$@")
...
data_folder=data/reuters/shuffled
export TOKENIZERS_PARALLELISM=false

output_dir=models/CF_${EXP_ID}_${model_name_log}_${decoding_format}_${data_name}_${lr_scheduler}_lr${lr}_ls${label_smoothing}_${batch_size}_wu${warmup_steps}
# harder_order_train
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python run_seq2seq.py \
    ...
    --seed=${seed}  \
    --save_steps=500 \
    --vanilla_seq2seq=${vanilla_seq2seq} \
    --random_order=0\
